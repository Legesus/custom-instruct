...
- `/antigravity`: Skills and workflows specifically for the Antigravity agent (including the `superpowers` module, `skill-writer`, `pentester-research`, and `code-simplifier` skills).
